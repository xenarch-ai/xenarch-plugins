import{cG as A,dg as l,cJ as w,cK as D,cL as C,c$ as $,cS as h,cM as u,d5 as V,cY as N,cU as S,d1 as M,dU as K,cZ as F,c_ as Q,cH as W,cI as H,ef as _}from"./config-CZ4K1Dc5.js";import{S as s}from"./SwapController-CNcV3ghk.js";import"./index-D4rYIheA.js";import"../xenarch-admin.js";const q={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",b=a==="c",I=a==="v",E=a==="x",L=n===",",R=n===".",B=n>="0"&&n<="9";!r&&(c||b||I||E)&&e.preventDefault(),t==="0"&&!L&&!R&&n==="0"&&e.preventDefault(),t==="0"&&B&&(o(n),e.preventDefault()),(L||R)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!B&&!i.includes(n)&&!R&&!L&&e.preventDefault()}},G=A`
  :host {
    width: 100%;
  }
