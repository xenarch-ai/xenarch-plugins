import{dU as k,en as le,cU as c,cW as pe,cG as v,cH as V,cK as f,cL as g,cM as d,cJ as l,df as $,d3 as H,dg as u,cI as me,c$ as w,cO as B,dd as U,ee as fe,d_ as F,cY as K,dR as A,d7 as M,cR as we,cV as E,dW as z,eb as oe,de as be,cQ as ce,eo as ge,ep as ye}from"./config-CZ4K1Dc5.js";import{P as D}from"./index-BN898dE6.js";import{S as ve}from"./SwapController-CNcV3ghk.js";import"../xenarch-admin.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
