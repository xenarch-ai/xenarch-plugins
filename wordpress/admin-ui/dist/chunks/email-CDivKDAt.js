import{cG as S,d5 as g,cO as h,cH as c,dq as _,d4 as s,cJ as f,cI as C,cY as D,c$ as b,dc as d,d0 as u,d2 as $,dY as W,d6 as P}from"../xenarch-admin.js";import{c as m}from"./index-DXZn5nRs.js";import{W as y}from"./index-C4kqT6RT.js";import{r as E}from"./class-map-DV5BW3Ot.js";import"./index-BzSCjAaB.js";import"./index-BDAob52S.js";import{e as N,n as T}from"./ref-pTJ9pojq.js";import"./index-cHnGnzcA.js";import"./index-BgOax2i0.js";import"./index-D7AKrR_3.js";import"./if-defined-C2DBv05z.js";import"./async-directive-CkvWqUyw.js";import"./index-DXCpt86V.js";var F=function(a,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends y{constructor(){super(...arguments),this.onOtpSubmit=async e=>{var t,r;try{if(this.authConnector){const n=S.state.activeChain,i=g.getConnections(n),o=(t=h.state.remoteFeatures)==null?void 0:t.multiWallet,l=i.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),n)await g.connectExternal(this.authConnector,n);else throw new Error("Active chain is not set on ChainController");if((r=h.state.remoteFeatures)!=null&&r.emailCapture)return;if(h.state.siwx){_.close();return}if(l&&o){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}_.close()}}catch(n){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:C.parseError(n)}}),n}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=F([m("w3m-email-verify-otp-view")],I);const U=D`
  wui-icon-box {
