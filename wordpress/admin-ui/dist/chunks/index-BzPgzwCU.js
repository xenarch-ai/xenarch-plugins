import{cY as g,c$ as f,d4 as u,d0 as e,cH as P,cZ as k,c_ as A}from"../xenarch-admin.js";import{r as y,n as w}from"./class-map-DV5BW3Ot.js";import{c as b}from"./index-DXZn5nRs.js";import"./index-C64X39me.js";import{H as x}from"./HelpersUtil-CvqF2l6R.js";import{o as v}from"./if-defined-C2DBv05z.js";import"./index-BzSCjAaB.js";import"./index-CUy_mQ7d.js";const I=g`
  :host {
    display: block;
  }
...
`;var m=function(t,i,n,r){var o=arguments.length,a=o<3?i:r===null?r=Object.getOwnPropertyDescriptor(i,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,n,r);else for(var c=t.length-1;c>=0;c--)(s=t[c])&&(a=(o<3?s(a):o>3?s(i,n,a):s(i,n))||a);return o>3&&a&&Object.defineProperty(i,n,a),a};const _={eip155:"ethereum",solana:"solana",bip122:"bitcoin",polkadot:void 0,cosmos:void 0,sui:void 0,stacks:void 0,ton:"ton",tron:"tron"};let l=class extends f{constructor(){super(...arguments),this.walletImages=[],this.imageSrc="",this.name="",this.size="md",this.tabIdx=void 0,this.namespaces=[],this.disabled=!1,this.showAllWallets=!1,this.loading=!1,this.loadingSpinnerColor="accent-100"}render(){return this.dataset.size=this.size,e`
      <button
